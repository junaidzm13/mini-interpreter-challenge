...
import com.csg.codeit.expression.ExpressionGeneratorUtils
import com.csg.codeit.expression.toTestCase
import com.csg.codeit.model.Output

fun convertedLegacyHardTestCases(): List<HardTestCase> = listOf<List<Expression>>(
    listOf(
        SetExpression("x", IntExpression(10)),
        PutsExpression(StrExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("x"),
                IntExpression(5)
            )
        ))),
    ...
    listOf(
        ...
        PutsExpression(StrExpression(GtExpression(MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(2),
                IntExpression(3),
                IntExpression(4)
        ...
        PutsExpression(StrExpression(LtExpression(DivideExpression(IntExpression(100), IntExpression(5)), MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(3), IntExpression(3))
        ))))
    ),
    ...
    listOf(
        ...
        SetExpression("c", SubtractExpression(VarExpression("b"), MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(2),
                IntExpression(10)
            )
        ...
        SetExpression("d", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("c"),
                DivideExpression(IntExpression(10), IntExpression(0))
            )
        )),
        PutsExpression(StrExpression(VarExpression("d"))),
        SetExpression("e", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("d"),
                IntExpression(50)
            )
    ...
    listOf(
        ...
        SetExpression("y", MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("x"),
                IntExpression(2)
            )
        ...
        SetExpression("invalidOperation", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
    ...
    listOf(
        SetExpression("a", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(100), MultiplyExpression(
                    ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                        SubtractExpression(IntExpression(200), DivideExpression(IntExpression(100), IntExpression(5))),
                        AddExpression(
                            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                                IntExpression(10),
                                MaxExpression(
        ...
        SetExpression("c", SubtractExpression(
            ...
            MinExpression(ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(30), IntExpression(40))))),
    ...
    listOf(
        SetExpression("x", StrExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(100), SubtractExpression(
                    IntExpression(200), MultiplyExpression(
                        ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                            IntExpression(3),
                            DivideExpression(IntExpression(300), IntExpression(10))
                        )
                    )
                )
            )
        ...
        SetExpression("b", SubtractExpression(VarExpression("a"), AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                MultiplyExpression(ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(2), IntExpression(3))),
                DivideExpression(
                    AddExpression(
                        ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                            MultiplyExpression(
        ...
        SetExpression("invalidOp", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("z"),
                VarExpression("a")
            )
        ...
        SetExpression("finalResult", DivideExpression(VarExpression("invalidOp"), (MinExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(AbsExpression(VarExpression("b")), IntExpression(0))
        )))),
    ...
    listOf(
        ...
        SetExpression("d", MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                SubtractExpression(
                    ...
                    MinExpression(ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(10), IntExpression(20)))
                ),
                AbsExpression(
                    SubtractExpression(
                        IntExpression(500),
                        DivideExpression(IntExpression(100), IntExpression(0))
                    )
                )
            )
        )),
        PutsExpression(StrExpression(EqualsExpression(
            SubtractExpression(VarExpression("d"), MultiplyExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                    VarExpression("a"),
                    IntExpression(2)
                )
        ...
        SetExpression("f", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                StrExpression(VarExpression("d")),
                UppercaseExpression(VarExpression("e"))
            )
        )),
    ...
    listOf(
        ...
        PutsExpression(StrExpression(EqualsExpression(
            SubtractExpression(
                VarExpression("d"),
                MultiplyExpression(ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(VarExpression("a"), IntExpression(2)))
            ),
            IntExpression(1000)
        ))),
        SetExpression("e", ConcatExpression(LowercaseExpression(StrExpression(VarExpression("d"))), StringExpression(" Nightmare"))),
    ...
    listOf(
        ...
        SetExpression("z", StrExpression(MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(
                    5
                ), IntExpression(6)
    ...
    listOf(
        SetExpression("x", StrExpression(MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(
                    10
                ), IntExpression(10)
        ...
        PutsExpression(StrExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                MultiplyExpression(
                    ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                        IntExpression(2),
                        SubtractExpression(IntExpression(10), DivideExpression(IntExpression(20), IntExpression(2)))
                    )
                ),
                SubtractExpression(IntExpression(5), IntExpression(2))
            )
        ))),
        PutsExpression((StrExpression(SubtractExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                MultiplyExpression(
                    ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                        IntExpression(2),
    ...
    listOf(
        SetExpression("x", AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                MultiplyExpression(
                    ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(2), IntExpression(3))
                ), SubtractExpression(IntExpression(10), DivideExpression(IntExpression(20), IntExpression(2)))
            )
        )),
        SetExpression("y", DivideExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("x"),
                IntExpression(10)
            )
        ), IntExpression(2))),
        PutsExpression(StrExpression(MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                VarExpression("y"),
                SubtractExpression(IntExpression(50), DivideExpression(VarExpression("x"), IntExpression(2)))
            )
        )))
    ),

    listOf(
        PutsExpression(ConcatExpression(StringExpression("Result: "), StrExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                MultiplyExpression(ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(3), IntExpression(4))),
    ...
    listOf(
        ...
        PutsExpression(ReplaceExpression(
            ...
            StrExpression(MultiplyExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                    IntExpression(2),
                    IntExpression((3))
                )
    ...
    listOf(
        SetExpression("a", ConcatExpression(StrExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(10),
                IntExpression((20))
            )
        ...
        PutsExpression(SubstringExpression(VarExpression("a"), SubtractExpression(MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(2), IntExpression((3)))
        ),
            IntExpression(4)), AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(3),
                IntExpression(3)
            )
    ...
    listOf(
        SetExpression("x", DivideExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                IntExpression(100),
                SubtractExpression(
                    MultiplyExpression(
            ...
            MultiplyExpression(ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(2), IntExpression(5))))),
    ...
    listOf(
        ...
        SetExpression("y", SubtractExpression(VarExpression("x"), DivideExpression(MultiplyExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(2), IntExpression(10))
        ), AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(IntExpression(5), IntExpression(5))
        )))),
        PutsExpression(StrExpression(AddExpression(
            ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                MultiplyExpression(
...
fun convertedLegacyIntermediateTestCases(): List<IntermediateTestCase> {
    return listOf(
        listOf(
            PutsExpression(StrExpression(AddExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
        ...
        listOf(
            PutsExpression(ConcatExpression(
                ...
                StrExpression(AddExpression(
                    ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                        DoubleExpression(5.0),
                        DoubleExpression(5.0)
                    )
                ))
            ))
        ...
        listOf(
            PutsExpression(StrExpression(MaxExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                    IntExpression(3),
                    IntExpression(9),
                    IntExpression(2),
            ...
            PutsExpression(StrExpression(MinExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                    IntExpression(3),
                    IntExpression(9),
                    IntExpression(2),
        ...
        listOf(
            PutsExpression(StrExpression(EqualsExpression(AddExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                    IntExpression(5),
                    IntExpression(5)
                )
            ), IntExpression(10)))),
            PutsExpression(StrExpression(GtExpression(AddExpression(
                ExpressionGeneratorUtils.ScalaUtils.toScalaSeq(
                    IntExpression(5),
                    StringExpression("5")
                )
